-- MOBALIS — correctif evaluer_badges (migration 0020)
-- Bug réel trouvé par e2e : `v_codes_acquis || 'code'` (text[] || text) était
-- résolu par Postgres comme une concaténation array||array, essayant de
-- parser le littéral 'code' comme un array literal ("malformed array
-- literal") au lieu d'un simple ajout d'élément. Remplacé par
-- array_append(), non ambigu.
